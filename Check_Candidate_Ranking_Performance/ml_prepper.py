...
class MLPrepper():
    ...
    def prep_greedy(self, input_df_modified_with_depot, chosen_company, chosen_candidates, method,
        ...
        for chosen_candidate in chosen_candidates:
            ...
            distance_matrix_vrp = distance_calc.calculate_distance_matrix(
                input_df_modified_with_depot, chosen_company=chosen_company, candidate_name=chosen_candidate,
    ...
    def prep_bounding_circle(self, df_input, df_input_modified, input_df_modified_with_depot,
                             sliced_distance_matrix_ranking,
    ...
    def prep_k_means(self, df_input, df_input_modified, df_input_modified_with_depot,
                     sliced_distance_matrix_ranking, squared_matrix, max_truck_cap,
    ...
    def prep_dbscan(self, df_input, df_input_modified, df_input_modified_with_depot, sliced_distance_matrix_ranking,
        ...
        for chosen_candidate in chosen_candidates:
            ...
            noise_points_amount = len(
                df_noise_assign[df_noise_assign['cluster'] == -1])  # Feature amount noise points
